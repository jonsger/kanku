-- Convert schema 'share/migrations/_source/deploy/5/001-auto.yml' to 'share/migrations/_source/deploy/4/001-auto.yml':;
...
;
INSERT INTO job_history SELECT id, name, state, args, result, creation_time, start_time, end_time, last_modified, worker FROM job_history_temp_alter;
